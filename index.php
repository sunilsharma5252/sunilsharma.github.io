<?php
   include ('include/header-light.php');
...
?>
 ...
 <!-- Start Testimonial 
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="title split-text">The best pricing plans to get your best</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Start Faq 
    ============================================= -->
    <div id="gallery" class="partner-style-one-area text-center default-padding overflow-hidden" style="padding-bottom: 5%;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="site-heading- text-center">
    ...
    ============================================= -->
    <?php
   include ('include/footer-light.php');
